...
const solutionLinearObstacle = solveFast(LinearFunc2D(endPointLowObstacle,0.0,midPointLowObstacle,1.0),LinearFunc2D(startPointHighObstacle,0.0,midPointHighObstacle,1.0))
